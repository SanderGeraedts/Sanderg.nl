...
- Ontwerp je layout op [keyboard-layout-editor.com](http://www.keyboard-layout-editor.com/)
    - Gebruik de "Raw data" knop om je layout te exporteren.
- Zet je layout om naar een DFX met [builder.swillkb.com](http://builder.swillkb.com/)
